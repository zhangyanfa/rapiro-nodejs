...
$(document).ready(function () {
  ...
  var converse = function(userText) {
    ...
    if( typeof(userText) !== undefined && userText != undefined && userText != 'undefined') {
        var ary = userText.split("");
        var tmp = "";
    ...
    var paramsStr = "input=" + userText;
    if (conversation_id) {
        paramsStr += "&conversation_id=" + conversation_id + "&client_id=" + client_id;
    }

    //$.post('/conversation', params)
    $.get('/conversation?' + paramsStr)
  ...
  var getProfile = function() {
    ...
    var paramsStr = "conversation_id="+conversation_id+"&client_id="+client_id;
    $.get('/profile?' + paramsStr).done(function(data) {
